...
import com.lakeHotel.lakeHotel.exception.InternalServerException;
import com.lakeHotel.lakeHotel.exception.ResourceNotFoundException;
import com.lakeHotel.lakeHotel.model.Room;
import com.lakeHotel.lakeHotel.repository.RoomRepository;
...
public class RoomServiceImpl implements IRoomService{
    ...
    public List<Room> getAvailableRooms(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        return roomRepository.findAvailableRoomsDateAndType(checkInDate, checkOutDate, roomType);
    }
}
